...
function Contact() {
  ...
  return (
    ...
    <div class="container">
    <h2>Get in touch!</h2>
    <p>Whether you'd like to know more about my experience or discuss your front-end development needs, I'd love to hear from you!</p>
    <p><FontAwesomeIcon icon={regular('envelope')} /> Email me at <a href="mailto:helenecatherinesauve@gmail.com"> helenecatherinesauve@gmail.com</a></p>
    </div>
    </>
